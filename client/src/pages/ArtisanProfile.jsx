    ...
    <ProfileContainer>
      <Hero>
        <HeroContent>
          ...
          <Info>
            ...
            >
              <MapPin size={18} /> {artisan.artisanProfile.location.city},{" "}
      ...
      <Section>
        ...
        <p style={{ fontSize: "1.1rem", lineHeight: "1.8", color: "#94a3b8" }}>
          {artisan.artisanProfile.bio || "No bio available."}
        </p>
      ...
      <Section>
        ...
        {artisan.artisanProfile.portfolio.length === 0 && (
          <p style={{ color: "#94a3b8" }}>No project images uploaded yet.</p>
        )}
      </Section>
      ...
      <Section>
        ...
        <p style={{ color: "#94a3b8", marginBottom: "2rem" }}>
          See what customers are saying about {artisan.name}
        </p>
