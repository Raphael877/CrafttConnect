  ...
  const handleSearch = () => {
    ...
    if (locationSearch.trim()) {
      ...
      const matchedState = NIGERIA_STATES.find(
        (s) => s.toLowerCase() === locationSearch.trim().toLowerCase(),
      );
      if (matchedState) {
        ...
        params.set(
          "search",
          `${params.get("search") || ""} ${locationSearch.trim()}`.trim(),
        );
      }
    }
  ...
  const categories = [
    {
      ...
      icon: <Zap />,
      description:
        "Expert electricians for wiring, repairs, and installations.",
    },
    {
      title: "Carpentry",
      icon: <Hammer />,
      description: "Professional carpenters for furniture, doors, and roofing.",
    },
    {
      title: "Tailoring",
      icon: <Scissors />,
      description: "Bespoke fashion designers and master tailors.",
    },
    {
      title: "Plumbing",
      icon: <Droplets />,
      description: "Skilled plumbers for pipes, leaks, and drainage systems.",
    },
  ];
    ...
    <HomeContainer>
      <HeroSection>
        ...
        >
          ...
          <Subtitle>
            The premium marketplace to find, hire, and manage professional
            services. In Nigeria, we bridge the gap between quality and
            reliability.
          </Subtitle>
      ...
      <CategoriesSection>
        <SectionHeader>
          ...
          <p>
            Explore our most requested services and find the right expert for
            your project.
          </p>
        </SectionHeader>
